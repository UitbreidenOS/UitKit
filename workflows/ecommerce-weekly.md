# E-commerce Operator Weekly Workflow

A repeatable weekly workflow for an AI-augmented e-commerce operator — covering sales monitoring, listing optimisation, customer service, email marketing, ad performance, and inventory management.

---

## Overview

**Time investment:** ~2-3 hours of structured Claude Code sessions per week (replaces 10-12 hours of manual work).

**What this workflow covers:**
- Every morning: sales dashboard + customer triage (20 minutes)
- Monday: weekly planning + email campaign launch
- Tuesday-Wednesday: listing and SEO work
- Thursday: ad performance and paid marketing
- Friday: weekly report + inventory planning

**Prerequisites:** At minimum `/ecommerce-seller`, `/product-listing-optimizer`, and `/review-response` installed.

---

## Daily — Morning routine (20 minutes, every day)
...
### Customer service triage (15 minutes)
...
## Monday — Week planning and email launch

### 9:00-9:30am — Week planning
...
### 9:30-10:30am — Email campaign launch
...
## Tuesday — Listing optimisation

### 9:00-11:00am — Listing work

**Prioritise by:** lowest conversion rate among your top 20 revenue SKUs.

**New or underperforming listing:**
...
**Seasonal refresh (if applicable):**
...
After every listing update, note: date, what changed, current conversion rate. Review in 14 days.

---

## Wednesday — SEO and competitor check

### 10:00-11:00am — Competitor and keyword review

Run this monthly, not weekly. But use Wednesdays for it when it comes up:
...
## Thursday — Paid ads and marketing performance

### 10:00-11:00am — Ad performance review
...
### 11:00-11:30am — Creative production (if needed)
...
## Friday — Weekly report and inventory planning

### 2:00-3:00pm — Inventory and reorder planning
...
### 3:00-4:00pm — Weekly performance report
...
### First week of month — Full reporting
...
### Seasonal planning (90-60 days before major events)
...
### "I have a negative review going viral"
...
### "A key product is out of stock and I'm losing ranking"
...
|---|---|---|
| Product conversion rate | > 3% (Shopify) / > 15% (Amazon) | < 1.5% / < 8% |
| Return rate | < 10% | > 20% |
| Negative review response rate | 100% | Any unresponded |
| Email ROAS | > 10x | < 5x |
| Paid ad ROAS | > 3x | < 2x |
| Stockout rate | < 2% of SKUs | > 5% |
| Customer response time | < 4 hours | > 24 hours |
| Listing update cadence | Monthly for top 20 SKUs | Quarterly or less |
