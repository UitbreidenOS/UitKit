...
Initialisiert ein Multi-Agent-Team durch Rollendefini­tion, Aufgabenpartitionierung und Etablierung von Koordinationsverträgen zwischen Agenten vor der Ausführung.

---

## Wann verwenden

- Starten eines neuen Multi-Agent-Workflows mit 3+ Agenten
- Onboarding neuer Agenten in ein bestehendes Team
- Skalierung eines Workflows zur Handhabung größerer, komplexerer Aufgaben
- Sicherstellen klarer Rollengrenzen, um Agent-Konflikte zu vermeiden
- Etablierung von Kommunikationsprotokollen, bevor Agenten freigelassen werden

Nicht verwenden für Single-Agent-Aufgaben oder Workflows, bei denen Agent-Rollen bereits klar definiert und in Produktion sind.

---

## Rollenzuweisung

Jeder Agent erhält eine Rollenkarte, die definiert, was er besitzt, wovon er abhängt und was er nicht tun darf:
...
**Rollenkarten-Regeln:**
- Eine Rolle pro Agent (Agenten haben nicht mehrere Rollen)
- Grenzen sind strikt — Agenten sollten Arbeit außerhalb ihrer Domäne ablehnen
- Abhängigkeiten definieren Sequenzierung und Blockierungsbeziehungen
- SLA definiert den Vertrag für akzeptable Leistung

---

## Aufgabenpartitionierung

Teilen Sie die Gesamtaufgabe in nicht-überlappende Unteraufgaben auf, die an spezifische Agenten zugewiesen sind:
...
- Kein Aufgabenüberlap (jede Aufgabe an genau einen Agent zugewiesen)
- Keine Lücken (Union aller Aufgaben = Gesamtziel)
- Explizite Abhängigkeiten (welche Unteraufgabe muss vor einer anderen abgeschlossen sein)
- Klare Akzeptanzkriterien (wie weiß der nächste Agent, dass Arbeit erledigt ist?)

---

## Koordinationsvertrag

Vor der Ausführung vereinbaren alle Agenten einen Koordinationsvertrag:
...
**Vertragserzwingung:**
- Alle Agenten verifizieren Vertragsbedingungen vor Arbeitsbeginn
- Verstöße (z. B. zirkulärer Aufruf) lösen sofortige Eskalation aus
- Supervisor erzwingt Timeout-, Wiederholungs- und Ressourcenlimits
- Audit-Log protokolliert alle Vertragskontrollen

---

## Pre-Execution Checkliste

Vor Freigabe der Agenten:
...
Fahren Sie mit der Ausführung nur fort, wenn alle Checklisten-Elemente erfüllt sind.
