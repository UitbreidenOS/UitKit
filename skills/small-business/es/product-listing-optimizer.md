...
description: "Optimizar listados de productos para SEO y conversión: título, puntos destacados, descripción, contenido A+, brief de imágenes"
---

# Habilidad: Optimizador de Listados de Productos

## Cuándo activar
- Lanzar un nuevo producto en Amazon, Shopify, Etsy, eBay u otros marketplaces
- Un listado existente tiene baja tasa de conversión, alta tasa de rebote o mal posicionamiento en búsquedas
- Preparar listados de temporada (T4, Prime Day, Black Friday) para máximo rendimiento
- Reescribir listados heredados que fueron redactados sin intención de SEO o CRO
- Construir Contenido A+ / Enhanced Brand Content para una marca en Amazon
- Crear un brief para un fotógrafo de productos para que las imágenes respalden el copy

## Cuándo NO usar
- Optimización masiva de 500+ SKUs a la vez — dividir en lotes de 20-30, priorizar por ingresos
- Productos digitales o de servicio — la estructura del listado difiere significativamente
- Productos de catálogo B2B donde el comprador es adquisiciones, no un consumidor
- Cuando aún no tienes el producto en mano — el copy sin conocimiento del producto produce relleno genérico

## Instrucciones

### Prompt de optimización completa de listado
...
### Prompt de investigación de palabras clave
...
### Motor de reescritura de puntos destacados
...
### Análisis de brecha con la competencia
...
### Auditoría de tasa de conversión
...
### Actualización estacional del listado
...
**Usuario:** Optimiza mi listado de Amazon para una botella de agua de acero inoxidable aislada. Es de 32 oz, mantiene las bebidas frías 24 horas, tiene tapa a prueba de goteos. El principal competidor es Hydro Flask. Precio de $28. Cliente objetivo: entusiastas del aire libre y asistentes al gimnasio.
