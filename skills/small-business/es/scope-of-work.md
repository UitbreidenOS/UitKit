---
name: scope-of-work
description: "Documento de alcance de trabajo: entregables, cronograma, responsabilidades, exclusiones, condiciones de pago y política de órdenes de cambio — protección contra la expansión del alcance y expectativas desalineadas"
---

# Skill de Alcance de Trabajo

## Cuándo activar
- Al iniciar cualquier nuevo compromiso con un cliente donde la ambigüedad pueda causar problemas más adelante
- Un cliente quiere avanzar pero no ha definido cómo se ve "terminado"
- Has tenido un problema de expansión de alcance antes y necesitas un contrato escrito sobre el alcance
- Un proyecto es lo suficientemente complejo como para que los entregables deban enumerarse (no solo describirse)
- Antes de redactar una factura — el SOW define para qué es la factura
- Cualquier compromiso superior a $2,000 o que dure más de 2 semanas

## Cuándo NO usar
- Tareas muy simples de una sola vez con un entregable único claro y sin ambigüedad — usa una factura con una breve descripción en su lugar
- Acuerdos de servicios legales que requieren cláusulas contractuales específicas de tu jurisdicción — haz que tu abogado los revise o redacte
- Adquisiciones gubernamentales o empresariales donde ellos proporcionan la plantilla del SOW — adapta su formato

## Importante

Esta skill genera documentos SOW profesionales para freelancers y consultores. El resultado es un documento profesional sólido pero no constituye asesoramiento legal. Para compromisos de alto valor (>$10K), haz que el SOW sea revisado por un abogado de contratos en tu jurisdicción. Incluye siempre tus cláusulas de ley aplicable y resolución de disputas.

## Instrucciones

### Prompt completo de alcance de trabajo
...
### Fases del proyecto / estructura de hitos

Para proyectos complejos, usa esto para estructurar el cronograma:
...
### Plantillas de política de revisiones

Elige la política de revisiones adecuada para tu tipo de trabajo:

**Para trabajo creativo (diseño, redacción, branding):**
```
REVISIONS
...
**Para trabajo técnico/de software:**
```
...
### Lista de verificación de señales de alerta en el SOW

Revisa cualquier SOW antes de firmarlo — el tuyo o el de un cliente:
...
### Formato de salida — documento SOW completo
...
**Usuario:** Soy un diseñador UX freelance. El cliente quiere un rediseño completo de su flujo de incorporación SaaS. Proyecto de 3 semanas. Haré descubrimiento, wireframes y maquetas de alta fidelidad en Figma. No han mencionado redacción de contenido ni especificaciones para entrega al equipo de desarrollo. $6,500 en total, 50% por adelantado.
