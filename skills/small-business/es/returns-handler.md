...
description: "Gestión de devoluciones y reembolsos: redacción de políticas, plantillas de respuesta, resolución de disputas, análisis de tendencias"
---

# Habilidad: Gestor de Devoluciones

## Cuándo activar
- Redactar o actualizar tu política de devoluciones y reembolsos
- Responder a una solicitud de devolución de un cliente, una demanda de reembolso o una queja
- Manejar un contracargo o disputa de pago
- Un cliente está escalando de forma agresiva y necesitas una respuesta mesurada
- Analizar datos de devoluciones para encontrar problemas de producto o proceso que elevan la tasa
- Capacitar al personal de atención al cliente en estándares de gestión de devoluciones

## Cuándo NO usar
- Disputas legales complejas — consulta a un abogado, no a Claude
- Procesamiento en volumen de devoluciones en tu panel de Shopify/WooCommerce — usa las herramientas nativas de tu plataforma
- Investigación de fraude que requiere análisis de datos a nivel de pedido — usa las herramientas de fraude de tu plataforma
- Casos donde ya has tomado una decisión comercial definitiva — no uses IA para ratificarla

## Instrucciones

### Generador de política de devoluciones
...
### Plantillas de respuesta a devoluciones de clientes
...
### Respuesta a disputa de contracargo
...
### Valores de referencia de tasa de devoluciones
...
**Usuario:** Un cliente exige un reembolso completo de $180 por unas botas. Dice "la suela ya se está despegando después de 3 semanas." Esto está dentro de mi período de 30 días. Ha enviado una foto borrosa que no muestra claramente el defecto.
