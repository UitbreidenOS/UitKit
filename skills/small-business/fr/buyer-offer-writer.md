...
description: "Lettre d'offre et lettre de motivation personnelle de l'acheteur : personnalisée à la situation du vendeur, met en valeur les atouts de l'acheteur, rédigée pour les situations à offres multiples compétitives et les vendeurs émotionnels"
---

# Compétence Rédacteur d'Offre Acheteur

## Quand activer
- Votre acheteur souhaite joindre une lettre personnelle à son offre (notamment lors de ventes émotionnelles ou de maisons familiales)
- Dans une situation à offres multiples et vous devez différencier votre acheteur au-delà du prix
- Rédaction de la lettre de couverture récapitulative de l'offre de l'agent vers l'agent mandataire
- Préparation d'une lettre pour un vendeur qui a vécu dans la maison depuis des décennies et se soucie de son héritage
- Votre acheteur renonce à des conditions suspensives et doit communiquer sa solidité financière de façon convaincante

## Quand NE PAS utiliser
- L'agent mandataire ou le vendeur a demandé qu'il n'y ait pas de lettres — respectez cela, certains vendeurs refusent pour éviter les risques liés au droit au logement équitable
- Transactions immobilières commerciales ou d'investissement — les décisions sont financières, pas émotionnelles
- La lettre révélerait des informations relatives à une classe protégée (taille du foyer, origine nationale, religion) — Claude signalera et supprimera ces éléments
- Ventes en difficulté (saisie, succession) où le décideur est une banque ou un tribunal

## Note sur le droit au logement équitable

Les lettres d'acheteur peuvent créer involontairement une responsabilité en matière de droit au logement équitable lorsqu'elles font référence au statut familial, à l'origine nationale, à la religion, à la race ou au handicap. Claude va :
- Signaler tous les détails que vous fournissez qui impliquent des caractéristiques de classe protégée
- Suggérer des alternatives conformes qui transmettent le même lien émotionnel
- Ne jamais inclure de détails sur le nombre d'enfants, les pratiques religieuses, l'origine nationale ou le statut de handicap

Vous êtes responsable de la révision finale avant soumission.

## Instructions

### Lettre de motivation personnelle (acheteur au vendeur)
...
### Lettre de couverture de l'agent (agent à agent)
...
### Explication de la clause d'escalade
...
### Invite de stratégie à offres multiples compétitives
...
**Utilisateur :** Mes acheteurs (un couple, prénoms Sarah et Tom) offrent 715 000 $ sur un bien affiché à 699 000 $ à Denver. Les vendeurs sont un couple à la retraite qui y habite depuis 25 ans. L'agent du vendeur dit qu'ils tiennent à ce que la maison aille à quelqu'un qui l'aimera, pas à un promoteur. Mes acheteurs sont tous deux enseignants, adorent le jardin en arrière-cour et souhaitent rester dans le quartier à long terme. Prêt conventionnel, 20 % d'apport, pré-approuvé jusqu'à 800 000 $ avec Chase. Renonciation à l'écart d'évaluation jusqu'à 20 000 $.
