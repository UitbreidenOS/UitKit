...
description: "Gestion des retours et remboursements : rédaction de politique, modèles de réponse, résolution des litiges, analyse des tendances"
---

# Compétence Gestionnaire de Retours

## Quand activer
- Rédaction ou mise à jour de votre politique de retours et de remboursements
- Réponse à une demande de retour, une exigence de remboursement ou une réclamation client
- Gestion d'un rétrofacturation ou d'un litige de paiement
- Un client s'escalade de façon agressive et vous avez besoin d'une réponse mesurée
- Analyse des données de retours pour trouver les problèmes de produit ou de processus qui font monter le taux
- Formation du personnel du service client aux standards de gestion des retours

## Quand NE PAS utiliser
- Litiges juridiques complexes — consultez un avocat, pas Claude
- Traitement en volume des retours dans votre admin Shopify/WooCommerce — utilisez les outils natifs de votre plateforme
- Enquêtes sur la fraude nécessitant une analyse des données au niveau des commandes — utilisez les outils de fraude de votre plateforme
- Cas où vous avez déjà pris une décision commerciale définitive — n'utilisez pas l'IA pour la cautionner

## Instructions

### Générateur de politique de retours
...
### Modèles de réponse aux retours clients
...
### Réponse à un litige de rétrofacturation
...
### Prévention de la fraude aux retours
...
### Références sur les taux de retour
...
**Utilisateur :** Un client exige un remboursement complet pour une paire de bottes à 180 $. Il dit que « la semelle se décolle déjà après 3 semaines. » C'est dans ma fenêtre de 30 jours. Il a envoyé une photo floue qui ne montre pas clairement le défaut.
