...
description: "Rapport de statut client hebdomadaire : avancement par rapport au plan, travail accompli, blocages, décisions nécessaires, aperçu de la semaine suivante — renforce la confiance et élimine les appels de suivi"
---

# Compétence Rapport de Statut Client

## Quand activer
- Vous devez envoyer une mise à jour hebdomadaire ou bimensuelle à un client et souhaitez la rendre professionnelle et cohérente
- Un projet est complexe et vous souhaitez garder une trace écrite de ce qui a été livré chaque semaine
- Un client devient silencieux et vous souhaitez vous réengager avec du contenu, pas avec un simple message de relance
- Vous voulez signaler proactivement les blocages avant qu'ils ne deviennent des plaintes
- Fin d'une période de facturation — qu'ont-ils obtenu pour leur argent ?

## Quand NE PAS utiliser
- Projets ponctuels simples avec une seule livraison — utilisez plutôt les notes de facture
- Mises à jour de gestion de projet en temps réel (utilisez Asana, Linear ou Notion pour cela)
- Gestion de projet orientée client où ils ont besoin d'un accès en direct au statut des tâches — utilisez un tableau de projet partagé

## Instructions

### Invite de rapport de statut hebdomadaire
...
### Rapport d'escalade (statut Jaune ou Rouge)

Quand quelque chose s'est mal passé ou est à risque :
...
### Rapport client sur contrat de prestation (engagement continu)

Pour les clients sur un contrat de prestation mensuel :
...
### Modèles de rapports par type de projet

**Projet logiciel / développement :**
```
...
### Modèle d'e-mail d'envoi du rapport
...
**Utilisateur :** Je suis stratège de contenu freelance. Client : une startup SaaS appelée Alora (le contact est Priya, Responsable Marketing). Semaine 3 d'un engagement de stratégie de contenu de 12 semaines. Accompli cette semaine : terminé le cahier de recherche de mots-clés (partagé dans Notion), animé l'atelier sur la voix de marque (3 personnes présentes), rédigé le calendrier éditorial pour le T3. Bloqué sur : n'a pas encore reçu leur feuille de route produit pour aligner le contenu avec les lancements. Besoin de leur part : approbation du calendrier éditorial pour pouvoir commencer la rédaction des briefs la semaine prochaine.
