---
name: scope-of-work
description: "Projectomschrijvingsdocument: deliverables, planning, verantwoordelijkheden, uitsluitingen, betalingsvoorwaarden en beleid voor wijzigingsopdrachten — bescherming tegen scopecreep en verkeerde verwachtingen"
---

# Vaardigheid: Projectomschrijving

## Wanneer activeren
- Bij het starten van elke nieuwe klantovereenkomst waarbij onduidelijkheid later problemen kan veroorzaken
- Een klant wil doorgaan maar heeft niet gedefinieerd hoe "gereed" eruitziet
- Je hebt eerder een scopecreepprobleem gehad en hebt een schriftelijk contract nodig over de scope
- Een project is complex genoeg dat deliverables moeten worden opgesomd (niet alleen beschreven)
- Voordat je een factuur schrijft — de SOW definieert waarvoor de factuur is
- Elke overeenkomst boven $2.000 of langer dan 2 weken

## Wanneer NIET gebruiken
- Zeer eenvoudige, eenmalige taken met één duidelijke deliverable en geen onduidelijkheid — gebruik in plaats daarvan een factuur met een korte omschrijving
- Juridische dienstverleningsovereenkomsten die specifieke contractclausules van jouw rechtsgebied vereisen — laat je advocaat deze controleren of opstellen
- Overheids- of bedrijfsprocurement waarbij zij de SOW-sjabloon aanleveren — pas hun formaat aan

## Belangrijk

Deze vaardigheid genereert professionele SOW-documenten voor freelancers en consultants. Het resultaat is een sterk professioneel document, maar het is geen juridisch advies. Laat de SOW voor overeenkomsten van hoge waarde (>$10K) controleren door een contractadvocaat in jouw rechtsgebied. Voeg altijd clausules toe over toepasselijk recht en geschillenbeslechting.

## Instructies

### Volledig prompt voor projectomschrijving
...
### Projectfasen / mijlpaalstructuur

Gebruik dit voor complexe projecten om de planning te structureren:
...
### Sjablonen voor herzieningsbeleid

Kies het juiste herzieningsbeleid voor jouw werktype:

**Voor creatief werk (ontwerp, schrijven, branding):**
```
REVISIONS
...
### Sjabloon voor wijzigingsopdracht
...
### Controlelijst voor rode vlaggen in SOW

Beoordeel elke SOW voordat je tekent — de jouwe of die van een klant:
...
### Uitvoerformaat — volledig SOW-document
...
**Gebruiker:** Ik ben een freelance UX-ontwerper. De klant wil een volledige herontwerp van hun SaaS-onboardingflow. Project van 3 weken. Ik doe discovery, wireframes en high-fidelity Figma-mockups. Ze hebben copywriting of ontwikkelaarsoverdrachtsspecificaties niet vermeld. $6.500 totaal, 50% vooraf.
