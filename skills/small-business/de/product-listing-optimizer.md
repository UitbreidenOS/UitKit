...
description: "Produktlistings für SEO und Conversion optimieren: Titel, Aufzählungspunkte, Beschreibung, A+ Content, Bild-Briefing"
---

# Product Listing Optimizer Skill

## Wann aktivieren
- Markteinführung eines neuen Produkts auf Amazon, Shopify, Etsy, eBay oder anderen Marktplätzen
- Ein bestehendes Listing hat eine niedrige Conversion-Rate, hohe Absprungrate oder schlechtes Suchranking
- Vorbereitung saisonaler Listings (Q4, Prime Day, Black Friday) für maximale Performance
- Überarbeitung von übernommenen Listings, die ohne SEO- oder CRO-Absicht verfasst wurden
- Erstellung von A+ Content / Enhanced Brand Content für eine Amazon-Marke
- Erstellung eines Briefings für einen Produktfotografen, damit Bilder den Text unterstützen

## Wann NICHT verwenden
- Massenoptimierung von 500+ SKUs auf einmal — in Chargen von 20–30 aufteilen und nach Umsatz priorisieren
- Digitale/Dienstleistungsprodukte — Listing-Struktur unterscheidet sich erheblich
- B2B-Katalogprodukte, bei denen der Käufer die Beschaffungsabteilung und kein Verbraucher ist
- Wenn du das Produkt noch nicht in der Hand hast — Texte ohne Produktkenntnisse produzieren generische Füllsel

## Anweisungen

### Vollständiger Listing-Optimierungs-Prompt
...
### Aufzählungspunkt-Überarbeitungs-Engine
...
### Saisonale Listing-Aktualisierung
...
**Nutzer:** Optimise my Amazon listing for a stainless steel insulated water bottle. It's 32oz, keeps drinks cold 24h, has a leak-proof lid. Main competitor is Hydro Flask. $28 price point. Target customer: outdoor enthusiasts and gym-goers.
