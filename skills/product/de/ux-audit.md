---
name: ux-audit
description: "UX-Audit gegen Heuristiken: Usability-Probleme identifizieren, nach Auswirkung priorisieren, Korrekturen empfehlen"
---

# UX-Audit Skill

## Wann aktivieren
- Du bewertest ein bestehendes Produkt oder Feature auf Usability-Probleme, ohne Benutzersitzungen durchzuführen
- Vor dem Launch: Du möchtest ein Expertengutachten einholen, bevor du in Benutzertests investierst
- Nach dem Launch: Ein Feature liefert unterdurchschnittliche Ergebnisse und du musst die Ursache diagnostizieren, ohne auf eine Forschungsrunde warten zu müssen
- Du hast ein Produkt übernommen und benötigst eine systematische Baseline-Bewertung
- Du möchtest eine priorisierte Fehlerliste für einen Design- oder Engineering-Sprint erstellen

## Wann NICHT verwenden
- Du benötigst tatsächliche Benutzerdaten — ein UX-Audit ist eine Expertenevaluation, keine Benutzerforschung; für benutzervalidierte Ergebnisse verwende `/usability-report`
- Du bewertest einen brandneuen Prototyp ohne Benutzeroberfläche — schreibe zuerst die Spezifikation
- Du musst die Qualität des visuellen Designs (Marke, Ästhetik) beurteilen — heuristische Evaluation deckt funktionale Usability ab, nicht Markendesign
- Du möchtest speziell die Barrierefreiheit überprüfen — führe ein dediziertes WCAG 2.2-Barrierefreiheitsaudit durch (die `/ux-audit`-Heuristiken überschneiden sich, ersetzen aber kein vollständiges a11y-Audit)

## Anweisungen

### Vollständiges heuristisches UX-Audit (Nielsens 10 Heuristiken)
...
### Schnellscan-Audit (einzelner Flow, 5 Minuten)
...
### Barrierefreiheit-Schnellcheck (WCAG-Kurzprüfung, neben den Heuristiken)
...
**Benutzer:** Auditiere den Onboarding-Flow für ein B2B-SaaS-Analysetool. Der Flow ist: Anmeldeformular → E-Mail-Verifizierung → Willkommensbildschirm mit "Lade dein Team ein" → Dashboard mit leerem Zustand → erster Datenverbindungsassistent. Benutzer steigen beim leeren Dashboard aus.
