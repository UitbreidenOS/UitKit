...
description: "Grobe Feature-Ideen in gut strukturierte User Stories mit Akzeptanzkriterien und Randfällen umwandeln"
---

# User-Story-Verfasser Skill

## Wann aktivieren
- Eine grobe Feature-Anfrage oder Idee in eine strukturierte User Story umwandeln
- Akzeptanzkriterien für eine bereits im Backlog vorhandene Story schreiben
- Randfälle und Fehlerzustände identifizieren, die das Engineering behandeln muss
- Ein Epic in Sprint-gerechte Stories aufteilen
- Eine vage Stakeholder-Anfrage in etwas verfeinern, das ein Entwickler umsetzen kann
- Die "Definition of Done" für ein Feature schreiben

## Wann NICHT verwenden
- Vollständiges PRD-Schreiben — verwende `/code-to-prd` zum Konvertieren von bestehendem Code, oder schreibe es von Grund auf neu
- Roadmap-Entscheidungen auf hoher Ebene — verwende `/product-roadmap`
- Discovery, bevor das Feature definiert ist — verwende zuerst `/product-discovery`
- API-Vertrag oder technische Spezifikation — das ist Engineering, nicht PM

## Anweisungen

### Kern-Story-Schreibprompt
...
### Techniken zur Story-Aufteilung
...
**Benutzer:** Wir brauchen eine Möglichkeit für Benutzer, ihre Daten zu exportieren. Das wird oft gewünscht. Unsere Benutzer sind hauptsächlich Datenanalysten, die Zahlen in Excel auswerten möchten.
