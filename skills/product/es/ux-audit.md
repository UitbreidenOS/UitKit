---
name: ux-audit
description: "Auditoría UX contra heurísticas: identificar problemas de usabilidad, priorizar por impacto, recomendar correcciones"
---

# Habilidad de Auditoría UX

## Cuándo activar
- Estás evaluando un producto o funcionalidad existente en busca de problemas de usabilidad sin realizar sesiones con usuarios
- Pre-lanzamiento: quieres una revisión experta antes de invertir en pruebas de usuario
- Post-lanzamiento: una funcionalidad tiene un rendimiento inferior y necesitas diagnosticar por qué sin esperar una ronda de investigación
- Has heredado un producto y necesitas una evaluación de referencia sistemática
- Quieres producir una lista de correcciones priorizadas para un sprint de diseño o ingeniería

## Cuándo NO usar
- Necesitas datos reales de usuarios — una auditoría UX es una evaluación experta, no investigación de usuarios; para hallazgos validados por usuarios, usa `/usability-report`
- Estás evaluando un prototipo completamente nuevo sin interfaz para revisar — escribe la especificación primero
- Necesitas evaluar la calidad del diseño visual (marca, estética) — la evaluación heurística cubre la usabilidad funcional, no el diseño de marca
- Quieres revisar la accesibilidad específicamente — ejecuta una auditoría de accesibilidad WCAG 2.2 dedicada (las heurísticas de `/ux-audit` se superponen pero no reemplazan una auditoría a11y completa)

## Instrucciones

### Auditoría UX heurística completa (10 Heurísticas de Nielsen)
...
### Auditoría rápida (flujo único, 5 minutos)
...
### Verificación rápida de accesibilidad (análisis WCAG rápido, junto a las heurísticas)
...
**Usuario:** Audita el flujo de incorporación de una herramienta de análisis SaaS B2B. El flujo es: formulario de registro → verificación de correo electrónico → pantalla de bienvenida con "invita a tu equipo" → panel con estado vacío → asistente de primera conexión de datos. Los usuarios abandonan en el panel de estado vacío.
