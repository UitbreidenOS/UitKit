...
description: "Informe de prueba de usabilidad: resúmenes de sesiones, calificaciones de severidad, hallazgos, recomendaciones priorizadas"
---

# Habilidad de Informe de Usabilidad

## Cuándo activar
- Has completado una ronda de pruebas de usabilidad (moderadas o no moderadas) y necesitas redactar los hallazgos
- Tienes notas de sesión sin procesar, grabaciones o registros de observadores que convertir en un informe estructurado
- Los interesados necesitan una lista priorizada de problemas antes de una revisión de diseño o una sesión de planificación de sprint
- Quieres puntuar y clasificar los problemas de usabilidad por severidad antes de decidir qué corregir
- Necesitas producir un artefacto compartible que los no investigadores (PMs, ingenieros, ejecutivos) puedan utilizar

## Cuándo NO usar
- Aún no has realizado sesiones — usa la habilidad `/ux-researcher` para planificar la prueba primero
- Quieres sintetizar entrevistas cualitativas (no tareas de usabilidad) — eso es síntesis de investigación, no un informe de usabilidad
- Necesitas una auditoría UX contra heurísticas sin sesiones — usa `/ux-audit`
- Quieres construir personas a partir de los datos — usa `/persona-builder` después de completar el informe

## Instrucciones

### Generador de informe de usabilidad completo
...
### Triaje rápido de severidad (pega notas sin procesar, obtén lista priorizada)
...
### Puntuación e interpretación SUS
...
### Esquema de presentación para interesados
...
**Usuario:** Realizamos 6 sesiones remotas moderadas probando nuestro nuevo flujo de pago. La Tarea 1 (aplicar un código de descuento) tuvo 3/6 completaciones. La Tarea 2 (cambiar la dirección de envío en el pago) tuvo 5/6. Observaciones principales: los usuarios buscan el campo de descuento en la parte inferior del carrito, pero está en la parte superior. Dos usuarios cerraron la pestaña pensando que habían roto algo cuando la página se recargó después de ingresar el código.
