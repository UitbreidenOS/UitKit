...
description: "Convierte ideas de funcionalidades en bruto en historias de usuario bien estructuradas con criterios de aceptación y casos extremos"
---

# Habilidad de Redacción de Historias de Usuario

## Cuándo activar
- Convertir una solicitud de funcionalidad o idea en bruto en una historia de usuario estructurada
- Escribir criterios de aceptación para una historia que ya está en el backlog
- Identificar casos extremos y estados de error que el equipo de ingeniería debe manejar
- Descomponer un épico en historias del tamaño adecuado para un sprint
- Refinar una solicitud vaga de un interesado en algo que un desarrollador pueda construir
- Escribir la "definición de terminado" para una funcionalidad

## Cuándo NO usar
- Redacción completa de PRD — usa `/code-to-prd` para convertir código existente, o escríbelo desde cero
- Decisiones de hoja de ruta de alto nivel — usa `/product-roadmap`
- Descubrimiento antes de que la funcionalidad esté definida — usa `/product-discovery` primero
- Contrato de API o especificación técnica — eso es ingeniería, no PM

## Instrucciones

### Prompt principal de redacción de historias
...
### Técnicas de división de historias
...
### Verificador de calidad de historias
...
**Usuario:** Necesitamos una forma para que los usuarios exporten sus datos. Ha sido muy solicitado. Nuestros usuarios son principalmente analistas de datos que quieren analizar números en Excel.
