...
description: "Construye un board pack: finanzas, panel de KPIs, iniciativas estratégicas, riesgos, solicitudes — a partir de datos en bruto"
---

# Habilidad de Construcción de Board Pack

## Cuándo activar
- Preparar un board pack mensual o trimestral a partir de datos financieros e informes de gestión
- Convertir datos brutos de hojas de cálculo en una narrativa lista para el consejo con contexto
- Estructurar un deck para el consejo de empresas en etapa Series A, B o C
- Preparar actualizaciones para inversores que siguen el formato de un board pack
- Briefing a un CFO o CEO sobre qué incluir en una próxima reunión del consejo

## Cuándo NO usar
- Comunicados de resultados de empresas públicas — formato diferente y requisitos de divulgación de la SEC
- Correos electrónicos de actualización para inversores de una sola página — usa una plantilla más ligera
- Materiales para el consejo que requieren revisión legal antes de su distribución — Claude redacta, los abogados aprueban
- Estados financieros auditados — Claude trabaja con cuentas de gestión, no con cifras auditadas

## IMPORTANTE

Todas las cifras financieras en los board packs deben estar marcadas con `[VERIFY]` hasta que se confirmen contra los datos fuente. Los board packs son documentos de toma de decisiones — presenta los datos con precisión y señala dónde se usan estimaciones. Nunca suavices cifras u omitas varianzas negativas sin divulgación.

## Instrucciones

### Estructura del board pack
...
### Seguimiento de iniciativas estratégicas
...
### Prompt del registro de riesgos
...
### Prompt de revisión del board pack
...
**Usuario:** Ayúdame a construir un board pack. Somos un SaaS Series B, $3.2M ARR, $280K/mes de burn, 14 meses de runway. El crecimiento MoM de ARR fue del 3.2% vs. presupuesto del 4.5%. El NRR es del 108%, el churn subió al 1.8% desde el 1.4% del mes anterior.
