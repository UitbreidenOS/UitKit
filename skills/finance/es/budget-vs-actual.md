...
description: "Análisis de presupuesto vs. reales: explicación de varianzas, identificación de tendencias, recomendaciones de reproyección"
---

# Habilidad de Presupuesto vs. Reales

## Cuándo activar
- Realizar un análisis mensual o trimestral de presupuesto vs. reales (BvA)
- Explicar varianzas a la dirección, el consejo o los inversores
- Identificar tendencias de forma temprana para permitir correcciones de rumbo
- Construir una reproyección después de una varianza significativa respecto al presupuesto original
- Producir una sección de comentario de gestión para acompañar los informes financieros

## Cuándo NO usar
- Preparación de estados financieros auditados — requiere un contador certificado
- Cálculo de impuestos — se aplican ajustes diferentes, usa un asesor fiscal
- Prospectos de cara a inversores — divulgación regulada, requiere revisión legal
- No tienes una línea base de presupuesto — realiza primero una sesión de planificación financiera (`/financial-plan`)

## IMPORTANTE

Todas las cifras de varianza deben llevar un marcador `[VERIFY]` hasta que se confirmen contra los datos fuente. El comentario de gestión solo es tan bueno como los datos que lo respaldan — señala dónde se han usado estimaciones, devengos o cifras preliminares.

## Instrucciones

### Prompt principal de análisis BvA
...
### Marco de análisis de varianzas
...
### Generador de tabla de varianzas
...
### Prompt de comentario de gestión
...
### Prompt de análisis de tendencias
...
### Plantilla de comentario del CFO
...
**Usuario:** Ejecuta un análisis BvA. Presupuesto de ingresos $500K, real $435K. Presupuesto de S&M $180K, real $162K. Presupuesto de I+D $210K, real $218K. Presupuesto de G&A $80K, real $74K. Presupuesto de burn neto $170K, real $219K.
