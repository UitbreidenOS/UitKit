...
description: "Budget-Ist-Analyse: Abweichungserklärung, Trenderkennung, Reforecast-Empfehlungen"
---

# Budget-Ist-Analyse Skill

## Wann aktivieren
- Monatliche oder vierteljährliche Budget-Ist-Analysen (BvA) durchführen
- Abweichungen gegenüber der Geschäftsführung, dem Vorstand oder Investoren erläutern
- Trends frühzeitig erkennen, um Kurskorrekturen zu ermöglichen
- Nach signifikanter Abweichung vom ursprünglichen Budget eine Neuprognose erstellen
- Einen Management-Kommentarteil erstellen, der Finanzberichte begleitet

## Wann NICHT verwenden
- Erstellung geprüfter Jahresabschlüsse — erfordert einen zugelassenen Buchhalter
- Steuerberechnung — andere Anpassungen sind anzuwenden, verwende einen Steuerberater
- Investorenprospekte — regulierte Offenlegung, erfordert rechtliche Überprüfung
- Du hast keine Budget-Basislinie — führe zuerst eine Finanzplanungssitzung durch (`/financial-plan`)

## WICHTIG

Alle Abweichungszahlen müssen einen `[VERIFY]`-Marker tragen, bis sie gegen die Quelldaten bestätigt wurden. Management-Kommentare sind nur so gut wie die dahinterliegenden Daten — kennzeichne, wo Schätzungen, Abgrenzungen oder vorläufige Zahlen verwendet wurden.

## Anweisungen

### Kern-BvA-Analyseprompt
...
**Benutzer:** Führe eine BvA-Analyse durch. Umsatzbudget 500.000 USD, Ist 435.000 USD. S&M-Budget 180.000 USD, Ist 162.000 USD. F&E-Budget 210.000 USD, Ist 218.000 USD. G&A-Budget 80.000 USD, Ist 74.000 USD. Netto-Burn-Budget 170.000 USD, Ist 219.000 USD.
