...
description: "Analyse post-appel de transcriptions pour les SDR : extraire le résultat, les prochaines étapes, les objections soulevées, les retours de coaching, et rédiger automatiquement des notes CRM + email de suivi à partir d'un enregistrement ou d'une transcription d'appel"
---

# Compétence d'analyse d'appels SDR

## Quand activer
- Vous venez de terminer un appel à froid ou un appel de découverte et devez le journaliser rapidement
- Vous avez une transcription ou un enregistrement d'appel et souhaitez des retours de coaching
- Votre équipe enregistre les appels (Gong, Aircall, Fireflies, Otter) et vous voulez une analyse par IA
- Vous souhaitez extraire automatiquement les notes CRM, les objections et les prochaines étapes d'un appel
- Manager SDR examinant la qualité des appels au sein de l'équipe

## Quand NE PAS utiliser
- Préparation avant l'appel — utilisez `/sdr-call-prep` pour cela
- Appels de succès client ou QBR — structure et objectifs différents
- Réunions internes d'équipe — non pertinent
- Appels sans transcription — vous avez besoin d'un texte en entrée (utilisez d'abord un outil de transcription)

## Instructions

### Prompt d'analyse complète d'appel
...
### Extraction rapide de notes CRM (< 1 minute)
...
### Extraction des objections et coaching
...
### Modèle d'intégration Gong / Aircall
...
### Revue groupée d'appels (vue manager)
...
### Modèles d'emails de suivi par résultat
...
**Utilisateur :** Analyse cet appel de 4 minutes. Marcus a dit « ce n'est pas le bon moment » mais semblait intéressé. Que dois-je faire ensuite ?

**Extrait de transcription :**
> Rep : « ...d'après vos recrutements, il semble que vous faites évoluer votre équipe commerciale. »
> Marcus : « Oui, c'est vrai, mais honnêtement ce n'est pas le bon moment — nous sommes en pleine réorganisation. »
> Rep : « Je comprends tout à fait. Quand pensez-vous que ce serait mieux ? »
> Marcus : « Probablement au T4 — août/septembre peut-être. »
> Rep : « Parfait — je vous recontacterai à ce moment-là. »
