...
description: "Rédaction de communications pour les parties prenantes : annonces à l'ensemble de l'entreprise, mises à jour sensibles, préparation des réunions générales, communications avec le conseil d'administration et messages de crise — pour les assistants de direction et les directeurs de cabinet soutenant les cadres"
---

# Compétence : Communications avec les Parties Prenantes

## Quand activer
- Rédaction d'une annonce à l'ensemble de l'entreprise (réorganisation, changement de direction, pivot produit, mise à jour de politique)
- Rédaction de communications sensibles qui pourraient être mal interprétées — licenciements, mauvaises nouvelles, changements difficiles
- Préparation du cadre dirigeant pour une réunion générale — script, préparation aux questions-réponses, messages clés
- Rédaction de communications avec le conseil d'administration — résumés de réunions, mises à jour hors cycle, demandes sensibles
- Communication avec les investisseurs, partenaires ou médias avec précision et soin
- Toute communication où un mot mal choisi au mauvais endroit crée un vrai problème

## Quand NE PAS utiliser
- Communications internes de routine sans risque — utilisez un email standard
- Dépôts légaux ou soumissions réglementaires — travaillez avec un conseiller juridique
- Communiqués de presse publics nécessitant une expertise en relations médias — coordonnez avec votre équipe RP
- Communications de crise en temps réel — cette compétence aide à rédiger, pas à gérer une réponse en temps réel

## Important

Les communications sensibles — en particulier celles concernant les licenciements, les transitions de direction et la performance financière — doivent être examinées par le service juridique et les RH avant distribution. Claude aide à rédiger efficacement et à détecter les problèmes de ton, mais ne remplace pas la révision juridique.

## Instructions

### Prompt d'annonce à l'ensemble de l'entreprise
...
### Annonce de changement de direction
...
### Communication de licenciement / réduction d'effectifs
...
### Communication avec le conseil d'administration — mise à jour hors cycle
...
### Résumé de réunion du conseil d'administration
...
### Communication sensible en 1:1 — cadre à rapport direct
...
**Utilisateur :** Notre PDG doit annoncer que nous fermons notre bureau de Londres et que nous offrons aux 12 employés concernés de passer en remote-first ou de bénéficier d'une rupture conventionnelle volontaire. L'entreprise est rentable, mais le bureau coûte 40 000 £/mois et l'équipe travaille essentiellement à distance depuis le COVID de toute façon. Nous avons besoin d'un email pour tous les employés, de points de discussion pour le responsable de Londres, et d'une note aux 12 employés directement concernés.
