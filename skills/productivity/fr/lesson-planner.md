---
name: lesson-planner
description: "Constructeur de plans de cours : objectifs d'apprentissage, plan de contenu, activités, évaluations, liste de matériaux et stratégies de différenciation — pour le K-12, l'enseignement supérieur et la formation en entreprise"
---

# Compétence : Planificateur de Cours

## Quand activer
- Planification d'un cours, d'une unité ou d'un module de zéro
- Adaptation d'un cours existant pour un public, un niveau ou un format différent
- Conception d'activités interactives allant au-delà du cours magistral
- Rédaction d'objectifs d'apprentissage clairs et mesurables (pas des objectifs vagues)
- Planification d'évaluations qui testent réellement ce que vous avez enseigné
- Différenciation pédagogique pour des classes ou des cohortes de niveaux mixtes

## Quand NE PAS utiliser
- Conception d'un curriculum complet couvrant un semestre ou une année — utilisez la compétence `/online-course-creator` pour cela
- Rédaction du contenu réel du cours (diapositives, fiches, lectures) — cette compétence planifie le cours, elle ne crée pas tout le contenu
- Conception de grilles d'évaluation à grande échelle — utilisez ceci comme point de départ, puis affinez avec une expertise de domaine

## Instructions

### Prompt de plan de cours complet
...
### Rédacteur d'objectifs d'apprentissage

La base de tout cours. À utiliser indépendamment :
...
### Cadre de conception d'activités
...
### Aperçu du plan d'unité (multi-cours)

Pour planifier une séquence de cours :
...
### Format de sortie du plan de cours
...
**Utilisateur :** Cours sur « Introduction à l'économie unitaire » pour une cohorte de 25 fondateurs de startups en phase précoce. Session de 90 minutes, en présentiel. Ils comprennent conceptuellement les revenus et les coûts, mais n'ont jamais calculé le CAC, la LTV ou le délai de remboursement. Mon objectif : qu'ils repartent capables de calculer et d'interpréter ces trois métriques pour leurs propres entreprises.
