...
description: "Technisch interviewpakket: ontwerp van codeeropdrachten, systeemontwerpprompts, beoordelingsrubric, debriefsjabloon"
---

# Tech Interview Kit Vaardigheid

## Wanneer activeren
- Het ontwerpen van een codeeroefening voor een software-engineeringfunctie
- Het schrijven van systeemontwerpprompts voor sollicitatiegesprekken op senior/staffniveau
- Het bouwen van een scoringsrubric zodat interviewers consistent beoordelen
- Het maken van een debriefsjabloon om na het interviewpanel te gebruiken
- Kalibreren wat de "lat" betekent voor een bepaald niveau (junior, mid, senior, staff)
- Het beoordelen van een bestaand interviewproces dat niet goed filtert

## Wanneer NIET gebruiken
- Gedrags- of cultuurinterviews — die vereisen HR-input en zijn niet puur technisch
- Het beoordelen van een specifieke inzending van een kandidaat — gebruik de rubric van deze vaardigheid, maar de beoordeling zelf is menselijk oordeel
- Niet-technische functies — volledig verkeerd hulpmiddel
- Massale screening van honderden kandidaten — gebruik een platform (HackerRank, Codility) voor take-homes op schaal

## Instructies

### Generator voor codeeropdrachten
...
### Systeemontwerp interviewprompt
...
### Beoordelingsrubric voor interviews
...
### Debriefsjabloon na het interview
...
**Gebruiker:** Ontwerp een take-home codeeropdracht voor een senior backend engineer. We gebruiken Python en PostgreSQL. We hechten waarde aan API-ontwerp, databaseschemabeslissingen en testdekking.
