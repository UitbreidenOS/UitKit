...
description: "Raamwerk voor leveranciersevaluatie: RFI/RFP-sjabloon, scoringsrubric, vergelijkingsmatrix, aanbevelingsmemo"
---

# Leveranciersevaluatie Vaardigheid

## Wanneer activeren
- Het evalueren van 2 of meer leveranciers voor een significante software-, dienst- of leveranciersbeslissing
- Het bouwen van een scoringsrubric vóór demo's of referentiegesprekken zodat de evaluatie consistent is
- Het schrijven van een RFI of RFP om naar potentiële leveranciers te sturen
- Het samenvatten van leveranciersvoorstellen in een vergelijkingsmatrix voor een beslissing
- Het opstellen van een leveranciersaanbevelingsmemo voor het management of een raad van bestuur
- Het uitvoeren van een verlengingsbeoordeling voor een bestaande leveranciersrelatie

## Wanneer NIET gebruiken
- Het kopen van iets goedkoop zonder echt alternatief (bijv. een enkel SaaS-hulpmiddel van €50/maand) — koop het gewoon
- Wanneer de beslissing al genomen is en je deze probeert te rationaliseren — wees eerlijk
- Juridische contractonderhandeling — dat is voor Juridische zaken met leverancierscontext; deze vaardigheid helpt bij het bepalen van de omvang en vergelijken, niet bij onderhandelen
- Het evalueren van sollicitanten — gebruik daarvoor een aannamrubric

## Instructies

### Volledige RFP-sjabloongenerator
...
### Scoringsrubric voor leveranciers
...
### Vergelijkingsmatrix voor leveranciers
...
### Aanbevelingsmemo voor leveranciers
...
### Raamwerk voor verlengingsevaluatie
...
**Gebruiker:** We kiezen tussen drie HRIS-systemen — BambooHR, Rippling en Workday. We zijn een B2B SaaS-bedrijf met 200 medewerkers. Help me ze te evalueren.
