...
description: "Technisches Interview-Kit: Design von Coding-Aufgaben, System-Design-Prompts, Bewertungsrubrik, Debriefing-Vorlage"
---

# Tech Interview Kit Skill

## Wann aktivieren
- Entwicklung einer Coding-Aufgabe für eine Software-Engineering-Stelle
- Verfassen von System-Design-Interview-Prompts für Senior-/Staff-Level-Einstellungen
- Erstellung einer Bewertungsrubrik, damit Interviewer konsistent bewerten
- Erstellung einer Debriefing-Vorlage für nach dem Interview-Panel
- Kalibrierung, was „die Messlatte" für ein bestimmtes Level bedeutet (Junior, Mid, Senior, Staff)
- Überprüfung eines bestehenden Interview-Prozesses, der nicht gut filtert

## Wann NICHT verwenden
- Verhaltens- oder Kulturinterviews — diese erfordern HR-Input und sind nicht rein technisch
- Bewertung der Einreichung eines bestimmten Kandidaten — nutze die Rubrik aus diesem Skill, aber die Bewertung selbst ist menschliches Urteilsvermögen
- Nicht-technische Stellen — völlig falsches Werkzeug
- Massenscreening von Hunderten von Kandidaten — verwende eine Plattform (HackerRank, Codility) für Take-home-Aufgaben in großem Maßstab
...
### Post-Interview-Debriefing-Vorlage
...
**Nutzer:** Design a take-home coding challenge for a senior backend engineer. We use Python and PostgreSQL. We care about API design, database schema decisions, and test coverage.
