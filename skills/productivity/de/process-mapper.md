---
name: process-mapper
description: "Geschäftsprozesse abbilden und dokumentieren: Flussdiagramm, RACI, Engpassidentifikation, Verbesserungsempfehlungen"
---

# Skill: Prozess-Mapper

## Wann aktivieren
- Dokumentierung eines bestehenden Prozesses, der nur im Kopf einer Person lebt
- Abbildung eines neuen Prozesses, bevor eine SOP oder Schulungsunterlagen erstellt werden
- Identifikation von Stellen, an denen Übergaben scheitern, Schritte sich verlangsamen oder Arbeit verloren geht
- Erstellung einer RACI-Matrix für abteilungsübergreifende Prozesse mit unklarer Eigentümerschaft
- Vorbereitung für ein Prozess-Audit, ISO-Zertifizierung oder operationale Überprüfung
- Vor der Automatisierung eines Workflows — erst manuell abbilden, dann Verschwendung eliminieren

## Wann NICHT verwenden
- Der Prozess ist bereits vollständig dokumentiert und aktuell — dafür `/sop-writer` verwenden
- Der Prozess involviert nur eine Person ohne Übergaben — eine einfache Checkliste verwenden
- Es wird eine technische Systemarchitektur abgebildet — das ist ein anderer Diagrammtyp
- Der Prozess existiert noch nicht und muss von Grund auf entworfen werden — zuerst eine Workflow-Design-Session durchführen

## Anweisungen

### Vollständiger Prozess-Mapping-Prompt
...
### Schnelle Prozessskizze (10-Minuten-Version)
...
**Nutzer:** Bilde unseren Lieferantenbeschaffungsprozess ab. Er beginnt, wenn ein Teamleiter ein neues Tool anfordert, und endet, wenn der Anbieter vertraglich gebunden und der Zugang bereitgestellt ist. Beteiligte: Teamleiter, Ops-Manager, Finance, Legal, IT.
