...
description: "Wöchentliche Gründer-Review: Unternehmensgesundheit, OKR-Check, Team-Puls, Prioritäten für die nächste Woche"
---

# Skill: Wöchentliche Gründer-Review

## Wann aktivieren
- Durchführung der wöchentlichen oder wochenbeginnenden Unternehmensreview
- Überprüfung des OKR-Fortschritts gegenüber den Quartalszielen
- Vorbereitung der wöchentlichen All-Hands- oder Führungssync-Agenda
- Entscheidung, worauf man sich persönlich in der nächsten Woche konzentriert
- Einschätzung, ob das Team überlastet, blockiert oder nicht ausgerichtet ist
- Verfassen eines wöchentlichen internen Update-Memos ans Team

## Wann NICHT verwenden
- Board-Vorbereitung — dafür den Skill `/board-deck-builder` verwenden
- Investoren-Update — dafür den Skill `/investor-update` verwenden
- Einmalige strategische Entscheidungen — dies ist ein Rhythmus-Tool, kein Entscheidungsrahmen
- Tiefgehende Finanzanalyse — dafür `/financial-plan` oder `/dcf-model` verwenden

## Anweisungen

### Kernprompt für die wöchentliche Review
...
### Wöchentliche All-Hands-Vorlage
...
**Nutzer:** Woche bis 1. Juni. ARR 890.000 $ (plus 22.000 $). Ein Abschluss über 12.000 $ ACV, ein Deal über 8.000 $ an Wettbewerber verloren. API-Rate-Limiting-Feature ausgeliefert. Ein Ingenieur war im 1:1 wortkarg und sagte, er fühle sich „überdehnt". Q2-OKR auf 1,1 Mio. $ ARR bis 30. Juni — jetzt gefährdet. Cash: 1,1 Mio. $ verbleibend, Burn 95.000 $/Monat.
