...
description: "Revisión semanal del fundador: salud de la empresa, seguimiento de OKR, pulso del equipo, prioridades para la próxima semana"
---

# Habilidad de Revisión Semanal del Fundador

## Cuándo activar
- Al realizar la revisión semanal de la empresa al final o al inicio de la semana
- Al verificar el progreso de los OKR frente a los objetivos trimestrales
- Al preparar la agenda de la reunión semanal general o de sincronización de liderazgo
- Al decidir en qué enfocarse personalmente la próxima semana
- Al detectar si el equipo está sobrecargado, bloqueado o desalineado
- Al redactar un memorando interno semanal de actualización para el equipo

## Cuándo NO usar
- Preparación para el consejo directivo — usa la habilidad `/board-deck-builder`
- Actualización para inversores — usa la habilidad `/investor-update`
- Decisiones estratégicas puntuales — esta es una herramienta de ritmo, no un marco de decisiones
- Análisis financiero profundo — usa `/financial-plan` o `/dcf-model`

## Instrucciones

### Prompt principal de revisión semanal
...
### Verificación del pulso del equipo
...
### Marco de asignación de tiempo para el CEO
...
### Plantilla de reunión general semanal
...
**Usuario:** Semana que termina el 1 de junio. ARR $890K (subió $22K). Cerramos un trato de $12K ACV, perdimos uno de $8K ante la competencia. Lanzamos la función de limitación de velocidad de API. Un ingeniero estuvo callado en la reunión 1:1 y dijo sentirse "sobrecargado". OKR del Q2 de $1,1M ARR para el 30 de junio — ahora en riesgo. Efectivo: quedan $1,1M, quema $95K/mes.
