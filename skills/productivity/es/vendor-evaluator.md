...
description: "Marco de evaluación de proveedores: plantilla de RFI/RFP, rúbrica de puntuación, matriz de comparación, memo de recomendación"
---

# Habilidad: Evaluador de Proveedores

## Cuándo activar
- Evaluar 2 o más proveedores para cualquier decisión significativa de software, servicio o suministro
- Construir una rúbrica de puntuación antes de demos o llamadas de referencia para que la evaluación sea consistente
- Redactar una RFI o RFP para enviar a posibles proveedores
- Resumir propuestas de proveedores en una matriz de comparación para tomar una decisión
- Redactar un memo de recomendación de proveedor para la dirección o un consejo
- Ejecutar una revisión de renovación sobre una relación existente con un proveedor

## Cuándo NO usar
- Comprar algo barato sin alternativa real (por ejemplo, una herramienta SaaS de $50/mes) — simplemente cómpralo
- Cuando la decisión ya está tomada y estás justificándola — sé honesto
- Negociación de contratos legales — eso corresponde al departamento Legal con el contexto del proveedor; esta habilidad ayuda a definir el alcance y comparar, no a negociar
- Evaluar candidatos laborales — usa una rúbrica de contratación en su lugar

## Instrucciones

### Generador de plantilla completa de RFP
...
### Memo de recomendación de proveedor
...
### Guion de verificación de referencias
...
### Marco de evaluación de renovación
...
### Referencia de tipo de rúbrica de puntuación
...
**Usuario:** Estamos eligiendo entre tres sistemas HRIS — BambooHR, Rippling y Workday. Somos una empresa SaaS B2B de 200 personas. Ayúdame a evaluarlos.
