...
description: "Kit de entrevistas técnicas: diseño de ejercicios de codificación, prompts de diseño de sistemas, rúbrica de evaluación, plantilla de sesión de revisión"
---

# Habilidad: Kit de Entrevistas Técnicas

## Cuándo activar
- Diseñar un ejercicio de codificación para un puesto de ingeniería de software
- Redactar prompts de entrevista de diseño de sistemas para contrataciones de nivel senior/staff
- Construir una rúbrica de puntuación para que los entrevistadores evalúen de forma consistente
- Crear una plantilla de sesión de revisión para ejecutar después del panel de entrevistas
- Calibrar cómo se ve el "nivel mínimo" para un determinado nivel (junior, intermedio, senior, staff)
- Revisar un proceso de entrevista existente que no está filtrando bien

## Cuándo NO usar
- Entrevistas de comportamiento o cultura — esas requieren aporte de RRHH y no son puramente técnicas
- Evaluar la entrega de un candidato específico — usa la rúbrica de esta habilidad, pero la evaluación en sí es juicio humano
- Roles no técnicos — herramienta completamente equivocada
- Evaluación masiva de cientos de candidatos — usa una plataforma (HackerRank, Codility) para ejercicios para llevar a casa a escala

## Instrucciones

### Generador de ejercicios de codificación
...
### Prompt de entrevista de diseño de sistemas
...
### Rúbrica de evaluación de entrevistas
...
### Plantilla de sesión de revisión post-entrevista
...
**Usuario:** Diseña un ejercicio de codificación para llevar a casa para un ingeniero de backend senior. Usamos Python y PostgreSQL. Nos importa el diseño de APIs, las decisiones de esquema de base de datos y la cobertura de pruebas.
