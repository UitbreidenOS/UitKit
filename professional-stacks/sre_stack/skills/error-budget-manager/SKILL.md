---
name: error-budget-manager
description: Define and manage error budgets — burn rate alerts, SLO policies, and risk allocation
...
- Define and manage error budgets — burn rate alerts, SLO policies, and risk allocation
...
```
SRE Initiative: error-budget-manager
